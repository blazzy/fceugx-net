...
enum machine_mode
{
  ...
  V1DImode,                /* config/rs6000/rs6000-modes.def:39 */
  ...
  V2SFmode,                /* config/rs6000/rs6000-modes.def:40 */
  V4SFmode,                /* config/rs6000/rs6000-modes.def:41 */
  V2DFmode,                /* config/rs6000/rs6000-modes.def:41 */
  MAX_MACHINE_MODE,
