...
#define ggc_alloc_zone_builtin_hash_struct(z) ((struct builtin_hash_struct *)(ggc_internal_zone_alloc_stat (z, sizeof (struct builtin_hash_struct) MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_builtin_hash_struct(z) ((struct builtin_hash_struct *)(ggc_internal_zone_cleared_alloc_stat (z, sizeof (struct builtin_hash_struct) MEM_STAT_INFO)))
#define ggc_alloc_zone_vec_builtin_hash_struct(n, z) ((struct builtin_hash_struct *)(ggc_internal_zone_vec_alloc_stat (z, sizeof (struct builtin_hash_struct), n MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_vec_builtin_hash_struct(n, z) ((struct builtin_hash_struct *)(ggc_internal_zone_cleared_vec_alloc_stat (z, sizeof (struct builtin_hash_struct), n MEM_STAT_INFO)))
...
#define ggc_alloc_zone_toc_hash_struct(z) ((struct toc_hash_struct *)(ggc_internal_zone_alloc_stat (z, sizeof (struct toc_hash_struct) MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_toc_hash_struct(z) ((struct toc_hash_struct *)(ggc_internal_zone_cleared_alloc_stat (z, sizeof (struct toc_hash_struct) MEM_STAT_INFO)))
#define ggc_alloc_zone_vec_toc_hash_struct(n, z) ((struct toc_hash_struct *)(ggc_internal_zone_vec_alloc_stat (z, sizeof (struct toc_hash_struct), n MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_vec_toc_hash_struct(n, z) ((struct toc_hash_struct *)(ggc_internal_zone_cleared_vec_alloc_stat (z, sizeof (struct toc_hash_struct), n MEM_STAT_INFO)))
